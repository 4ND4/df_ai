...
def create_model():
    ...
    model.add(Convolution2D(64, 3, 3, activation='relu', border_mode='same', input_shape=(image_size, image_size, 1)))
...
history = vgg16.fit(X_train, Y_train, batch_size=batch_size, nb_epoch=epochs,
